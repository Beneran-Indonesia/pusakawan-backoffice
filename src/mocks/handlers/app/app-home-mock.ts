...
const MOCK_HOME: Post[] = [{
    ...
    description: 'Welcome to the Pusakawan learning app! We hope you are all excited to learn today.',
...
},
{
    ...
    description: 'Join us for an exciting workshop this weekend! Learn new skills and meet fellow students.',
    timestamp: '1 day ago',
    status: 'draft'
},
{
    ...
    description: 'Congratulations to all students who completed the Indonesian Heritage Challenge! Your dedication is inspiring.',
