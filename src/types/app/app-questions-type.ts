...
const BaseQuestionSchema = z.object({
  id: z.string(),
  question: z.string().min(1, "Question text is required").max(300),
  media: z
    .object({
      id: z.string(),
...
const MultipleChoiceQuestionSchema = BaseQuestionSchema.extend({
  ...
  options: z.object({
    a: z.string().min(1, "This answer option is required").max(100),
    b: z.string().min(1, "This answer option is required").max(100),
    c: z.string().min(1, "This answer option is required").max(100),
    d: z.string().min(1, "This answer option is required").max(100),
  }),
